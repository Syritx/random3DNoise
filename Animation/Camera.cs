...
namespace DNoise
{
    public class Camera
    {
        ...
        public Camera(Game gwindow) {
            window = gwindow;

            gwindow.KeyDown += keyDown;
            gwindow.UpdateFrame += update;

            gwindow.MouseDown += mouseDown;
            gwindow.MouseUp += mouseUp;
            gwindow.MouseMove += mouseMove;
        }
